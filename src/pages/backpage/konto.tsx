        ...
        <div className="w-4/5 p-2 relative">
          <div className="h-[7rem] w-full flex items-center shadow-md">
            ...
            <div className="w-1/2 flex justify-end mr-4">
              ...
              <button onClick={noEditAlert} className="ml-8 py-2 w-[10rem] bg-primary rounded flex justify-center text-background font-semibold items-center hover:border hover:border-primary hover:bg-background hover:text-primary">Rediger bruker</button>
            </div>
          </div>
          <div>
          <div >
    <div className="container mx-auto py-8">
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex flex-col items-center">
                        <img src="https://hips.hearstapps.com/hmg-prod/images/drake_photo_by_prince_williams_wireimage_getty_479503454.jpg" className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">

                        </img>
                        <h1 className="text-xl font-bold">Real McUser</h1>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <ul>
                            ...
                            <li className="mb-2">Andre verdenskrig</li>
                            <li className="mb-2">Strikking</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div className="col-span-4 sm:col-span-9">
                <div className="bg-white shadow rounded-lg p-6">
                    <h2 className="text-xl font-bold mb-4">Om meg</h2>
