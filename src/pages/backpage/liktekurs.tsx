        ...
        <>
            <main className="w-screen h-screen bg-background flex">
                <div className="w-1/5 bg-primary pt-8">
                    ...
                    <Link href="/" className="w-full flex flex-start py-4 pl-4 hover:bg-background font-semibold text-background hover:text-primary">Tilbake</Link>
                    <button className="w-full flex flex-start py-4 pl-4 hover:bg-background font-semibold text-background hover:text-primary"><Link href="/">Logg ut</Link></button>
                </div>
